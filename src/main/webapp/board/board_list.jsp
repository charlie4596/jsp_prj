...
//	pageContext.setAttribute("endNum", endNum); 
	...
	<tr>
		...
		<td><a href="board_detail.jsp?num=${bVO.num }&currentPage=${currentPage}${searchParam}"><c:out value="${bVO.subject }"></c:out></a></td>
	...
	<%
		...
		if(currentPage > pageNumber){//현재 페이지가 pagination 수 보다 크다면
			//이전으로 가기 링크를 만들어 준다.
