...
<div id="wrap">
	<%
	//sessionㅇ느 내장객체이므로 scriptlet나 expression에서 사용할 수 있다.
	//1.세션 값 읽기
	...
	<button class="btn btn-sm btn-priamry">입력</button>
	
	</form>
	<%}else{ %>
	세션에 값 있습니다.<br>
	<button type="button" class="btn btn-primary">
  <%= name %>님 안녕하세요? <span class="badge text-bg-secondary">나이는 <%=age %>입니다. </span>
</button>
<br>
