...
<%@ page import="java.util.Date, java.util.Calendar, java.time.LocalDate" %>
...
<table class="table table-hover">
	<tr>
		...
		<tr>
			...
			<td>
				<%for(int j=0 ; j<11;j++){ %>
					<input type="radio" name="score<%=i%>" value="<%=j %>"점 <%=j==0?"checked":""%>><%=j %>점
				<%}//end for %>
			</td>
		</tr>
		<%}//end for %>
...
%>	
<div class="card" style="width: 18rem float/:let">
  <img src="http://192.168.10.228/jsp_prj/day1001/images/<%=iVO.getImg()%>"
...
<%
	//scriptlet에서는 method를 작성할 수 없다. ( 자바문법에서는 method를 중첩정의할 수 없다.)
	public test(){
